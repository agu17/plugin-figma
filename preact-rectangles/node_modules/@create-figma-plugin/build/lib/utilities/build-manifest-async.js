...
export async function buildManifestAsync(minify) {
    ...
    const { api, build, commandId, containsWidget, editorType, enablePrivatePluginApi, enableProposedApi, id, main, menu, name, parameterOnly, parameters, permissions, relaunchButtons, ui, widgetApi } = config;
