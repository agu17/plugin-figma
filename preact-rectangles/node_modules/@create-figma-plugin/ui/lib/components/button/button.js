...
export function Button({ children, danger = false, disabled = false, fullWidth = false, loading = false, onClick, propagateEscapeKeyDown = true, secondary = false, ...rest }) {
    ...
    return (h("div", { class: createClassName([
        ...
        ]) }, loading === true ? (h("div", { class: styles.loadingIndicator }, h(LoadingIndicator, null))) : null, h("button", { ...rest, disabled: disabled === true, onClick: disabled === true || loading === true ? undefined : onClick, onKeyDown: disabled === true || loading === true ? undefined : handleKeyDown, tabIndex: disabled === true ? -1 : 0 }, h("div", { class: styles.children }, children))));
}
