...
export function Dropdown({ disabled = false, icon, name, options, onChange = function () { }, onValueChange = function () { }, placeholder, value, variant, ...rest }) {
    ...
    return (h("div", { ...rest, ref: rootElementRef, class: createClassName([
        ...
        ]), onFocus: handleRootFocus, onKeyDown: disabled === true ? undefined : handleRootKeyDown, onMouseDown: handleRootMouseDown, tabIndex: disabled === true ? -1 : 0 }, typeof icon === "undefined" ? null : (h("div", { class: dropdownStyles.icon }, icon)), value === null ? (typeof placeholder === "undefined" ? (h("div", { class: dropdownStyles.empty })) : (h("div", { class: createClassName([
            dropdownStyles.value,
            dropdownStyles.placeholder
        ]) }, placeholder))) : (h("div", { class: dropdownStyles.value }, children)), h("div", { class: dropdownStyles.chevronIcon }, h(IconControlChevronDown8, null)), variant === "underline" ? (h("div", { class: dropdownStyles.underline })) : null, h("div", { class: dropdownStyles.border }), h("div", { ref: menuElementRef, class: createClassName([
            menuStyles.menu,
            dropdownStyles.menu,
